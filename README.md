...
With the way _pytprot_ fetches the stoichiometry, it is not possible to correctly build the model. Nevertheless, if we download one the asymmetric units, which are found in its same PDB page, it can be almost perfectly built with _pytprot_, whenever stoichiometry is provided, as shown here and detailed in the **_Theory & Analysis_** pdf.

<img src="./images/6om3_asymm.png" alt="6om3 asymmetric subunit" width="400">
